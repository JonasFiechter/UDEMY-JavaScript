...
console.log(). a string like "Poll results are 13, 2, 4, 1"This should be the default option. 
If type is 'string', display .
...
const poll = {
    ...
    displayResults() {
        const result = `JavaScript: ${this.answers[0]} | Python: ${this.answers[1]} | Rust: \
                                   ${this.answers[2]} | C++: ${this.answers[3]}`
...
resultsBtn.addEventListener('click', poll.displayResults.bind(poll))
